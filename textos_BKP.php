...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '3') {
    ...
    $texto .= "<p>Nuestra oficina de inspecciones está certificada por diferentes organismos entre los que se encuentra GAFTA y FOSFA. A su vez, su gestión de calidad en todos sus servicios de inspección están avalados bajo la certificación de la norma <a href='./images/Certificados/ISO9001.pdf' target='_BLANK'>ISO 9001:2015</a> y la acreditación de la norma <a href='./images/Certificados/CERTIFICADO_DE_ACREDITACION_17020.pdf' target='_BLANK'>ISO 17020:2013</a>, según el <a href='./images/Certificados/_alcance_.pdf' target='_BLANK'>alcance</a> adjunto.</p>";
    ...
    $texto .= "<a href='./images/Certificados/TYCBS.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a> / <a href='./images/Certificados/TYCBSen.pdf' target='_BLANK'>English Version </a>";
    $texto .= '<iframe src="./images/Certificados/TYCBS.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $texto .= "<ul>
...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '5') {
    ...
    $texto .= "<ul>
                ...
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('6C')>GAFTA - Certificado</a></li>
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('7C')>FOSFA - Certificado</a></li>
