...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '2') {
    ...
    $texto .= "<strong style='color:black;'>SERVICIOS ANAL&Iacute;TICOS</strong>";
...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '3') {
    ...
    $texto .= "<p>Nuestra oficina de inspecciones está certificada por diferentes organismos entre los que se encuentra <a href='https://www.gafta.com/Superintendents' target='_blank'>GAFTA</a> y <a href='https://www.fosfa.org/member-search/' target='_blank'>FOSFA</a>. A su vez, su gestión de calidad en todos sus servicios de inspección están avalados bajo la certificación de la norma <a href='./images/Certificados/ISO9001.pdf' target='_BLANK'>ISO 9001:2015</a> y la acreditación de la norma <a href='./images/Certificados/CERTIFICADO_DE_ACREDITACION_17020.pdf' target='_BLANK'>ISO 17020:2013</a>, según el <a href='./images/Certificados/_alcance_.pdf' target='_BLANK'>alcance</a> adjunto.</p>";
    ...
    $texto .= "<p><b style='color:black'>Para <a  href='./images/Certificados/quejas.pdf' target='_BLANK'>quejas</a>  y apelaciones comunicarse a: jcmorandeyra@alexstewart.com.ar y/o cristinabeltrame@alexstewart.com.ar</b></p>";
    
       
    $texto .= "<a href='./images/Certificados/Terminos_y_Condiciones_Generales.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a> / <a href='./images/Certificados/Terminos_y_Condiciones_Generales_English.pdf' target='_BLANK'>English Version </a>";
    $texto .= '<iframe src="./images/Certificados/Terminos_y_Condiciones_Generales.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $texto .= "<ul>
...
//    $texto .= "<img src='./images/Certificados/ISO9001.jpg' class='img img-responsive' alt='' />";
    $texto .= "<a href='./images/Certificados/DNV2021.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/DNV2021.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $titulo .= "ISO 9001";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '2') {
    $texto = '<iframe src="./images/Certificados/17025(2019).pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $titulo .= "ISO 17025";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '1a') {
    $texto = '<iframe src="./images/Certificados/alcance.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $titulo .= "Alcance";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '3') {
    $texto = '<iframe src="./images/Certificados/Alcance17025(2019).pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
//    $texto .= "<img src='./images/Certificados/Alcance17025(2019).png' class='img img-responsive' alt='' />";
...
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '5') {
    $texto .= "<a href='./images/Certificados/CAA N452 - RP - Vto 31-03-20.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
...
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '6') {
    $texto .= "<a href='./images/Certificados/CAA N813 Maza Vto 31-03-20.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
...
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '7') {
    $texto .= "<a href='./images/Certificados/CAAN525PMVto19-06-19.pdf' target='_BLANK'>Click aquí si no puede visualizarlo</a>";
...
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '5C') {
    $texto .= "<a href='./images/Certificados/senasa.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/senasa.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    //$texto .="<img src='./images/Certificados/Certificado ambiental G-452 Lab RP.jpg' class='img img-responsive' alt='' />";

    $titulo .= "SENASA - Registro de controladores y certificadores de granos y productos con destino a la exportaci&oacute;n";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '6C') {
    $texto .= "<a href='./images/Certificados/gafta.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/gafta.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    //$texto .="<img src='./images/Certificados/Certificado ambiental G-813 Lab Maza.jpg' class='img img-responsive' alt='' />";
    $titulo .= "GAFTA - Certificado";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '7C') {
    $texto .= "<a href='./images/Certificados/fosfa.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/fosfa.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    //$texto .="<img src='./images/Certificados/CAA generador de residuos peligrosos-PM.jpg' class='img img-responsive' alt='' />";
    $titulo .= "FOSFA - Certificado";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '8C') {
    $texto .= "<a href='./images/Certificados/certificado_de_acreditacion_17020.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/certificado_de_acreditacion_17020.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    //$texto .="<img src='./images/Certificados/CAA generador de residuos peligrosos-PM.jpg' class='img img-responsive' alt='' />";
    $titulo .= "Otorgamiento de la acreditación";
}
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '9C') {
    $texto .= "<a href='./images/Certificados/Alcance_acred_OI_026_09-09-2021.pdf' target='_BLANK'>Click aquí si no puede visualizarlo </a>";
    $texto .= '<iframe src="./images/Certificados/Alcance_acred_OI_026_09-09-2021.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    //$texto .="<img src='./images/Certificados/CAA generador de residuos peligrosos-PM.jpg' class='img img-responsive' alt='' />";
    $titulo .= "Alcance de la acreditación";
}
...
if (isset($_REQUEST['optionimg']) && $_REQUEST['optionimg'] == '11') {

    $texto .= "<a href='./images/Certificados/Habilitacion DPA Lab Maza 2019.pdf' target='_BLANK'>Click aquí si no puede visualizarlo</a>";
    $texto .= '<iframe src="./images/Certificados/Habilitacion DPA Lab Maza 2019.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $titulo .= "Habilitaci&oacute;n de laboratorio ambiental en la direcci&oacute;n de protecci&oacute;n ambiental (DPA) -  Mendoza.";
}
...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '5') {
    ...
    $texto .= "<p>No siendo suficiente para nosotros certificar nuestros laboratorios bajo un sistema de gestión de la calidad, en nuestro laboratorio de Mendoza, hemos logrado la acreditación de la Norma <a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('2')>ISO 17025:2017</a>; <a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('3')>Alcance 17025:2017 </a> en determinaciones que nos ubican a la vanguardia en este rubro:</p>";
    $texto .= "<ul>
    ...
    $texto .= "<p><i>Nota: La acreditación se mantiene suspendida temporalmente debido a la mudanza del laboratorio hasta que el OAA verifique el cumplimiento de los requisitos en las nuevas instalaciones.</i></p>";

    $texto .= "<p>Asimismo, en el laboratorio de Palpal&aacute;, Jujuy, tambi&eacute;n se ha obtenido la acreditaci&oacute;n de la Norma ISO 17025:2017 con el <a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('1a')>alcance</a> vinculado a determinaci&oacute;n de litio en salmueras l&iacute;quidas por ICP.</p>";
    ...
    $texto .= "<h4>Acreditación en ISO17020:2013 como Organismo de Inspección y Certificaciones Agroindustriales en Buenos Aires</h4>";
    //href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('6C')
    $texto .= "<ul>
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('5C')>SENASA - Registro de controladores y certificadores de granos y productos con destino a la exportaci&oacute;n</a></li>
                <li><a href='https://www.gafta.com/Superintendents' target='_blank'>GAFTA - Certificado</a></li>
                <li><a href='https://www.fosfa.org/member-search/' target='_blank'>FOSFA - Certificado</a></li>
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('8C')>Otorgamiento de la acreditación</a></li>
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('9C')>Alcance de la acreditación</a></li>
                
               </ul>";

    $texto .= "<h4>Habilitaciones Ambientales</h4>";
    $texto .= "<ul>
                <li><a href=# data-toggle=modal data-target=#myModalimg onclick=loadimg('11')>Habilitaci&oacute;n de laboratorio ambiental en la direcci&oacute;n de protecci&oacute;n ambiental (DPA); Mendoza</a></li>
    ...
    $texto .= "Para más información <br /><a href='../noticias/noaQAQC2021.pdf' target='_BLANK'>Click aquí (QA-QC) NOA </a>";
    $texto .= '<object data="../noticias/noaQAQC2021.pdf" type="application/pdf" style="width:100%;height:250px"><embed src="../noticias/noaQAQC2021.pdf" type="application/pdf" /></object>';
...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '6') {
    ...
    $texto .= "<a href='./images/Certificados/PoliticaIntegral2020.pdf' target='_BLANK'>Click aquí si no puede visualizarlo (QA-QC)</a>";
    $texto .= '<iframe src="./images/Certificados/PoliticaIntegral2020.pdf" style="width:800px; height:600px;" frameborder="0"></iframe>';
    $titulo .= "POL�?TICA DE CALIDAD Y AMBIENTE";
}
...
if (isset($_REQUEST['option']) && $_REQUEST['option'] == '8') {
    $texto .= '<div class="titulo_boton" style="color:black">Podés ser parte de nuestro gran equipo de trabajo.</div>
                        ...
                        <div class="col-lg-6">
                            <div class="btn btn-success" style="bottom:auto;cursor:pointer;margin-top:2rem;margin-bottom:2rem;" onclick="enviar_cv();" id="btcv">Enviar</div>
                        </div>
                        <div class=row></div>
    ...
    $titulo .= "TRABAJ&Aacute; CON NOSOTROS";
}
if (isset($_REQUEST['option']) && $_REQUEST['option'] == 'terminos') {
    include("terminos.php");
    $titulo .= "Términos y condiciones";
}

if (isset($_REQUEST['option']) && $_REQUEST['option'] == '9') {
    $texto .= '             <div class="col-lg-6">
                                <label for="" style="color:black"></label><br>
                                <input  style="width:100%" id="buscarOrdencita" type="text" value="' . $_REQUEST['orden'] . '" name="buscarOrdencita" maxlength="10"/>
                            </div>
                            <div class="col-lg-6">
                            <div class="btn btn-success" style="bottom:auto;cursor:pointer;margin-top:2rem;margin-bottom:2rem;" onclick="loadorden(10);" id="btorde">Buscar</div>
                        </div>';
    $titulo .= "Ingrese Orden a buscar";
}


if (isset($_REQUEST['option']) && $_REQUEST['option'] == '10' && isset($_REQUEST['orden']) && $_REQUEST['orden'] != '') {
    ...
    $sucu = "";
    $texto = "";
    if (strpos($_REQUEST['orden'], 'M') !== false || strpos($_REQUEST['orden'], 'm') !== false) {
        $sucu = "M";
    }
    if (strpos($_REQUEST['orden'], 'PM') !== false || strpos($_REQUEST['orden'], 'pm') !== false) {
        $sucu = "_PM";
    }
    if (strpos($_REQUEST['orden'], 'NOA') !== false || strpos($_REQUEST['orden'], 'noa') !== false) {
        $sucu = "M";
    }
    ...
    if ($sucu != "") {
        ...
        include "./db.php";
        $texto .= '';
//        $texto .= "SELECT * FROM ordenes" . $sucu . "  WHERE n_orden='" . $_REQUEST['orden'] . "' GROUP BY nombre_sector ORDER BY id_orden ASC";
        //SELECT * FROM ordenes WHERE n_orden='M155900' GROUP BY nombre_sector ORDER BY id_orden ASC
        $consulta = mysqli_query($mysqli, "SELECT * FROM ordenes" . $sucu . "  WHERE n_orden='" . $_REQUEST['orden'] . "' GROUP BY nombre_sector ORDER BY id_orden ASC");
        $frecep = $fmuestrera = $flab = $fcert = "";
        $aREC = $aCERT = $aMUE = $aLAB = "";
        if (mysqli_num_rows($consulta) == 0) {
            $aREC = " class='active' ";
            $fecha_informe = " ";
        }
        while ($ordenes = mysqli_fetch_array($consulta)) {
            $fecha_ingreso_db = explode(" ", $ordenes['fecha_ingreso']);
            $fecha_ingreso = convertir_fecha_server_a_normal($fecha_ingreso_db[0]);
            $hora_ingreso = $fecha_ingreso_db[1];
            $fecha_informe = $ordenes['fecha_informe'];
            switch ($ordenes['nombre_sector']) {
                case "Recepcion":
                    $frecep = $fecha_ingreso;
                    if ($frecep != "") {
                        $aREC = "class='active'";
                        $aCERT = "";
                        $aMUE = "";
                ...
                default:
                    $aREC = " class='active' ";
                    $fecha_informe = "A&uacute;n no cargada en el sistema.";
                    break;
            }


//            $texto .= '</br>';
//            $texto .= '' . $fecha_ingreso . ' - ' . $hora_ingreso . '';
//            $texto .= ' - ' . $ordenes['nombre_sector'] . '';
//            $texto .= '';
        }
        $texto .= '<div style="width:100%;">
            <table>
  <div>
    <div class="d-none d-md-block col-xl-12 pb-6">
      <div class="card">
        <div class="card-body responsive">
          <ul class="stepped-progress-bar">
            <li ' . $aREC . '>Recepci&oacute;n</br>' . $frecep . '</li>
            <li ' . $aMUE . '>Muestrera</br>' . $fmuestrera . '</li>
            <li ' . $aLAB . '>Laboratorio</br>' . $flab . '</li>
            <li >Certificaciones</br>' . $fcert . '</li>                   
            <li ' . $aCERT . '>Enviado</br>' . $fcert . '</li>                   
          </ul>
        </div>
        </div>
        </div>
        ...
        $texto .= "<div class='text-center'><strong style='color:green;'>Fecha estimada de reporte: $fecha_informe </strong></div> <br></br>";
        $texto .= "</hr><strong style='color:black;'> <small>Para mayor informaci&oacute;n ingrese con su usuario y contrase&ntilde;a a nuestro sistema. En caso de no tener datos de ingreso contactarse con atencion.cliente.mza@alexstewart.com.ar</small></strong>";
    }

    $titulo .= "Seguimiento " . $_REQUEST['orden'];
}
